...
class Flipper(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "Flipper"  # TODO: make this more human readable by adding spaces
        self.parent.categories = ["MeiqiTools"]  # TODO: set categories (folders where the module shows up in the module selector)
        self.parent.dependencies = []  # TODO: add here list of module names that this module requires
        self.parent.contributors = ["HHX (cad420)"]  # TODO: replace with "Firstname Lastname (Organization)"
...
#         thumbnailFileName=os.path.join(iconsPath, 'Flipper1.png'),
#         # Download URL and target file name
#         uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
#         fileNames='Flipper1.nrrd',
...
#         category='Flipper',
#         sampleName='Flipper2',
#         thumbnailFileName=os.path.join(iconsPath, 'Flipper2.png'),
#         # Download URL and target file name
#         uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
#         fileNames='Flipper2.nrrd',
...
class FlipperWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath('UI/Flipper.ui'))
        ...
        self.ui.flipButton_i.connect('clicked(bool)', self.onFlipButton_i)
    ...
    def onFlipButton_i(self):
        """
        在i方向上翻转volume
        """
        self.onFlipButton(2)
        
    def onFlipButton_j(self):
        """
        在j方向上翻转volume
        """
        self.onFlipButton(1)

    def onFlipButton_k(self):
        """
        在k方向上翻转volume
        """
        self.onFlipButton(0)
    ...
    def _vtkimage2array(self, img):
        """
        vtkImageData转为numpy 3D数组
        """
        i, j, k = img.GetDimensions()
        sc = img.GetPointData().GetScalars()
        arr = vtk.util.numpy_support.vtk_to_numpy(sc)
        arr = arr.reshape(k, j, i)
        return arr
    
    def _array2vtkimage(self, arr, img):
        """
        numpy 3D数组赋给已有的vtkImageData
        """
        vtk_data = vtk.util.numpy_support.numpy_to_vtk(
            arr.ravel(), array_type=vtk.VTK_INT)
        img.GetPointData().SetScalars(vtk_data)
    
    def onFlipButton(self, val):
        ...
        # selectedArray = self._vtkimage2array(img)
...
class FlipperLogic(ScriptedLoadableModuleLogic):
...
class FlipperTest(ScriptedLoadableModuleTest):
    """
    ...
    def test_Flipper1(self):
        ...
        import SampleData
        registerSampleData()
        inputVolume = SampleData.downloadSample('Flipper1')
